...
import strinitialpop.HierarchycalInstanceTimeSeriesStrategy;
import strinitialpop.RandomInstanceTimeSeriesStrategy;
import strinitialpop.TensorStrategy;

public class InstanceTimeSeriesInitialPop implements InitialPop {

	private InitialPopStrategy aleatoria;
	private InitialPopStrategy jerarquica;
	private InitialPopStrategy tensores;

	public InstanceTimeSeriesInitialPop() {

		aleatoria = new RandomInstanceTimeSeriesStrategy();
		jerarquica = new HierarchycalInstanceTimeSeriesStrategy();
