...
public class FitnessUtilities {
	...
	public static double [] meanOfViews (List<Double> gCdifferences, List<Double> gTdifferences, List<Double> tGdifferences) {
	...
	private static double [] fromListToArray (List<Double> listOfDouble){
	...
	public static double [][][] buildAnglesCubeT1 (double[][][] transformation){
...
//					if (atan<0) rotacion = atan + (2*Math.PI);
	...
	private static double angleTransformationT1(double angle){
	...
	//*************************************************************************************NUEVO->INICIO
	public static double [][][] buildAnglesCubeT2 (double[][][] transformacion){
...
//					if (atan<0) rotacion = atan + (2*Math.PI);
	...
	private static double angleTransformationT2(double angle){
	...
	public static List<Double> buildTableOfDifferencies (double [][][] angles){
	...
	public static double [][] buildTableOfAngles (double[][][] transformation){
...
public static double [][] buildTableOfAnglesT2 (double[][][] transformation){
	...
	public static double[] getTotalsArray(List<Double> gCdifferencies, List<Double> gTdifferencies, List<Double> tGdifferencies) {
	...
	private static double computeSlope(int series, int graphic, double[][][] transformation, double xSum, double xxSum) {
	...
	private static double computeDifference(double[][][] angles, int aRow, int aColumn, int bRow, int bColumn) {
	...
	public static double applyAtanRotation (double valor){
		
		double atan = Math.atan(valor);
		
		if (atan<0) atan = (atan + (2*Math.PI));
