...
public class MslXYbias implements FitnessFunction {

	@SuppressWarnings("unused")
	private static final Logger LOG = LoggerFactory.getLogger(MslXYbias.class);
	...
	public void evaluate(AlgorithmIndividual individual) {
		...
		if (total_events>BIAS_VALUE) {
			...
			measure = mslts.calculate(individual)/HIGHEST_LSL_MULTI;	
